...
-(void)showResultAndImage:(UIImage *)image
{
  ...
  NSDictionary *tempDict=@{
                           @"carType":_sVehicleLicense.nsVehicleType,
                           @"carOwner":_sVehicleLicense.nsOwner,
                           @"carAddress":_sVehicleLicense.nsAddress,
                           @"carNature":_sVehicleLicense.nsUseCharacter,
                           @"carBrand":_sVehicleLicense.nsModel,
                           @"carVl":_sVehicleLicense.nsVIN,
                           @"carEngine":_sVehicleLicense.nsEngineNo,
                           @"carReg":_sVehicleLicense.nsRegisterDate,
                           @"carCert":_sVehicleLicense.nsIssueDate,
                           };
  
   [self dismissViewControllerAnimated:YES completion:^{
     self.scaneResult(tempDict,@"扫描失败");
   }];
