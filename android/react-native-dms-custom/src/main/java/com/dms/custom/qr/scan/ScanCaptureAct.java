package com.dms.custom.qr.scan;
...
public class ScanCaptureAct extends Activity {
    ...
    private LinearLayout capture_scan_hand;
    ...
    private void findViewById() {
        ...
        capture_scan_hand = (LinearLayout) findViewById(R.id.capture_scan_hand);
    }
    ...
    private void addEvents() {
        ...
        capture_scan_hand.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent rIntent = new Intent();
                rIntent.putExtra("SCAN_RESULT", "");
                rIntent.putExtra("SCAN_HAND", true);
...
//				barcodeScanned = true;
                ...
                rIntent.putExtra("SCAN_HAND", false);
                setResult(RESULT_OK, rIntent);
